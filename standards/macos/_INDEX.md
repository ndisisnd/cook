...
| macos → architecture-and-state ref | `**/*Model.swift`, `**/*Store.swift`, `**/*ViewModel.swift`, `**/*Service.swift` | @Observable, @Bindable, ObservableObject, SwiftData, Core Data, @Environment, MVVM |
| macos → windows-and-scenes ref | — | WindowGroup, MenuBarExtra, NSStatusItem, NSPanel, openWindow, Commands, FocusedValue, DocumentGroup, activation policy |
...
| macos → performance-accessibility ref | — | Instruments, Time Profiler, beachball, VoiceOver, accessibilityLabel, Dynamic Type, App Nap |
